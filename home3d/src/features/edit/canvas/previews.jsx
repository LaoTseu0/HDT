...
// Aperçus éphémères du tracé (étape C1 du découpage d'EditObjects) : plan
// contextuel au survol, aperçu du draft en cours (rect/cercle/arc/run), marqueur
...
export function ContextualPlanePreview({ hover }) {
...
export function SnapMarker({ snap }) {
...
export function InferenceLines({ snap }) {
