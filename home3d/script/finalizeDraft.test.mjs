...
import { finalizeDraft } from '../src/store/useStore.js'
import { CABLE_KIND } from '../src/lib/cable.js'
import { PIPE_KIND } from '../src/lib/plumbing.js'
...
describe('finalizeDraft (persistance run — #28)', () => {
  it('run câble ≥ 2 sommets : committé en objet, draft soldé', () => {
    ...
    const created = Object.values(patch.objects ?? {})
    assert.equal(created.length, 1)
    assert.equal(created[0].kind, CABLE_KIND)
    assert.equal(created[0].params.points.length, 3)
